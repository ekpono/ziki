        ...
        <div class="row">
		  ...
		  <a href="/views/timeline.php">
                ...
                <ul class="nav flex-column p-5 my-5 text-center">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="/views/user-profile-setting.php">Settings</a>
                    </li>
		    <li class="nav-item">
                ...
                <div class="row posts">
                    <div class="col-md-12 col-12">
						...
						<a href="#">
                                            ...
                                            <div class="col-md-4 col-5 text-right">
                                                <a href="/views/blog-detail.php"><i class="far fa-comment-alt post-icon chat-icon"></i></i></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
